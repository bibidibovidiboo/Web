...
public class MelonManager {
    ...
    {
    	MelonDAO dao=new MelonDAO(); // 이거 꼭 있어야함
    	try
    	{
    		int k=1;
    		for(int i=1;i<=1;i+=50)
    		{
	    		Document doc=Jsoup.connect("https://www.melon.com/genre/song_list.htm?gnrCode=GN0800#params%5BgnrCode%5D=GN0800&params%5BdtlGnrCode%5D=&params%5BorderBy%5D=NEW&params%5BsteadyYn%5D=N&po=pageObj&startIndex="+i).get(); // 바뀌는 부분 1
