...
// 영화번호(no)에 해당되는 영화정보를 가지고 와서 출력
// DAO를 이용해서 처리
...
<body>
	...
	<tr>
		<td>
			<%-- 동영상 출력 <embed> <iframe> --%> <iframe
				src="http://youtube.com/embed/<%=vo.getKey()%>" width=850 height=450></iframe>
		</td>
	</tr>
	</table>
	<table class="table">
		<tr>
			<td width=30% cclass="text-center" rowspan="7"><img
				src="<%=vo.getPoster()%>" width=100%></td>
