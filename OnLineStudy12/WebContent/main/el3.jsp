...
<%-- tab 라이브러리 첨부 --%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %> <!-- uri 주소 ctrl + space 하면 나옴 -->
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>JSPL 반복문 예제 </title>
</head>
<body>
	<h1>Java로 반목분 사용</h1>
	<%
	...
	<br>
	<h1>JSTL로 반복문 사용</h1>
	<c:forEach var="i" begin="1" end="10" step="1"><%--  step은 1씩 증가 시 생략이 가능  --%>
		${i }&nbsp;
	</c:forEach>
	<br>
	...
	<%--
		request.setAtrribute("color","red,blue,yellow,green,white");
